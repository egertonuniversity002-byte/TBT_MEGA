...
<head>
  ...
  <title>Team Level 1 - Active</title>
  <style>
...
<body>
  <div class="container">
    <h2>Level 1 - Active Referrals</h2>
    <p class="muted">Users directly referred by you and considered active.</p>
...
<script>
  ...
  async function load() {
    try {
      const res = await fetch(`${API_BASE}/team/list?level=1&status=active`, { headers: { 'Authorization': `Bearer ${token}` }});
