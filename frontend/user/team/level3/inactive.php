...
<head>
  ...
  <title>Team Level 3 - Inactive</title>
  <style>
...
<body>
  <div class="container">
    <h2>Level 3 - Inactive Referrals</h2>
...
<script>
  ...
  async function load() {
    try {
      const res = await fetch(`${API_BASE}/team/list?level=3&status=inactive`, { headers: { 'Authorization': `Bearer ${token}` }});
