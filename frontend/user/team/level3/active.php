...
<head>
  ...
  <title>Team Level 3 - Active</title>
  <style>
...
<body>
  <div class="container">
    <h2>Level 3 - Active Referrals</h2>
...
<script>
  ...
  async function load() {
    try {
      const res = await fetch(`${API_BASE}/team/list?level=3&status=active`, { headers: { 'Authorization': `Bearer ${token}` }});
