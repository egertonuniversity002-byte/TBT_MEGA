...
<head>
    ...
    <title>TikTok Earn | Matrix Platform</title>
    ...
    <style>
        ...
        .claim-btn { background: #000000; color: white; padding: 0.75rem 1.5rem; border-radius: 8px; border: none; cursor: pointer; }
    </style>
</head>
<body>
    <div class="max-w-4xl mx-auto p-6">
        <div class="flex items-center gap-3 mb-6">
            ...
            <h1 class="text-3xl font-bold">TikTok Earn</h1>
        </div>
        <p class="text-gray-600 mb-6">Complete TikTok tasks and earn rewards.</p>
    ...
    <script>
        ...
        async function loadTasks() {
            try {
                const response = await fetch(`${API_BASE}/tasks?category=tiktok&page=1&limit=10`, {
                ...
                if (data.status === 'success') {
                    ...
                    if (tasks.length === 0) {
                        document.getElementById('tasksContainer').innerHTML = `
                            <div class="text-center py-8">
                                <i class="fab fa-tiktok text-6xl text-gray-300 mb-4"></i>
                                <h3 class="text-xl font-semibold mb-2">No Tasks Available</h3>
                                <p class="text-gray-600">Check back later for new TikTok tasks.</p>
                            </div>
                        `;
                        return;
                    }
                    ...
                    document.getElementById('tasksContainer').innerHTML = tasks.map(task => `
                        <div class="task-card">
                            ...
                            <p class="text-black font-medium mb-3">Reward: ${task.priceDisplay}</p>
